...
- [ ] 1.2 Criar dashboard/checklist de readiness com status P0/P1/P2 e evidências anexadas por item. (owner: product/engineering)
...
- [ ] 2.5 Publicar health checks operacionais (readiness/liveness) como evidência de gate de release. (owner: backend/infra)
...
- [ ] 4.3 Definir alertas operacionais para falhas de cobrança e reconciliação. (owner: infra/finance)
...
- [ ] 5.2 Garantir escopo de dados por responsável/aluno e auditoria de acesso. (owner: backend/qa)
...
- [ ] 8.6 Executar simulado de incidente (tabletop + rollback) e registrar lições aprendidas. (owner: ops/infra)

## 9. Produto e lançamento

- [ ] 9.1 Criar onboarding guiado para escola piloto. (owner: product/frontend)
- [ ] 9.2 Criar material de treinamento para administrador escolar. (owner: product/docs)
