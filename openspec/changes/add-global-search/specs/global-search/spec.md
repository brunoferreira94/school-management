...
Enable rapid navigation through the School Management system via a command palette-style global search interface that allows users to find and access features by typing keywords, similar to VS Code Command Palette or Windows Search.

## Requirements

### Added Requirement: Quick feature discovery
...
### Added Requirement: Permission-aware results
...
### Added Requirement: Keyboard-first interaction
...
### Added Requirement: Recent search tracking
