...
- [x] Enhance search results with recency
  ...
  - [ ] Show recent searches when input is empty (optional)
...
- [ ] Performance validation
  - [ ] Measure search time with full route index
  - [ ] Check bundle size impact
  - [ ] Verify no memory leaks (especially localStorage)
...
- [ ] Create demo/tutorial
  - [ ] Record short video showing search feature
